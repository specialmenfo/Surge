...
if (url.search(configurations) != -1) {
    getOrigin(url)
    if ($.caller == 'wta') $.done() // 丟棄caller=wta的configurations數據
...
function outputData(api, caller, platform, locale, region) {
    ...
    if (api == "v1") $.done()
        ...
        configurations.data.applicationProps.storefront.localesSupported = ["zh_Hant", "zh_Hans", "en_US", "en_GB"];
...
function createTabsGroup(type, caller, platform, locale, region) {
    ...
    if (esl == "zh_Hant" || region == "CN") {
        if (platform == "iphone" || platform == "ipad") var maps = new Map([['Watch Now', '立即觀看'], ['Originals', '原創內容'], ['Movies', '電影'], ['TV', '電視節目'], ['Sports', '體育節目'], ['Kids', '兒童'], ['Store', '商店'], ['Library', '資料庫'], ['Search', '搜索']])
        else var maps = new Map([['Watch Now', '立即觀看'], ['Apple TV+', 'Apple TV+'], ['Movies', '電影'], ['TV', '電視節目'], ['Sports', '體育節目'], ['Kids', '兒童'], ['Store', '商店'], ['Library', '資料庫'], ['Search', '搜索']]);
        Tabs = Tabs.map(element => { element.title = maps.get(element.title); return element; });
    };
    /*
    if (platform == "desktop" && esl == "zh_Hant") { WatchNow.title = "立即觀看"; Originals.title = "Apple TV+"; Movies.title = "電影"; TV.title = "電視節目"; Sports.title = "體育節目"; Kids.title = "兒童"; Library.title = "資料庫"; Search.title = "搜索" }
    else if (platform == "iphone" && esl == "zh_Hant") { WatchNow.title = "立即觀看"; Originals.title = "原創內容"; Movies.title = "電影"; TV.title = "電視節目"; Sports.title = "體育節目"; Kids.title = "兒童"; Library.title = "資料庫"; Search.title = "搜索" }
    else if (platform == "ipad" && esl == "zh_Hant") { WatchNow.title = "立即觀看"; Originals.title = "原創內容"; Movies.title = "電影"; TV.title = "電視節目"; Sports.title = "體育節目"; Kids.title = "兒童"; Library.title = "資料庫"; Search.title = "搜索" }
    else if (platform == "appletv" && esl == "zh_Hant") { WatchNow.title = "立即觀看"; Originals.title = "Apple TV+"; Movies.title = "電影"; TV.title = "電視節目"; Sports.title = "體育節目"; Kids.title = "兒童"; Library.title = "資料庫"; Search.title = "搜索" }
    else if (platform == "atv" && esl == "zh_Hant") { WatchNow.title = "立即觀看"; Originals.title = "Apple TV+"; Movies.title = "電影"; TV.title = "電視節目"; Sports.title = "體育節目"; Kids.title = "兒童"; Library.title = "資料庫"; Search.title = "搜索" }
    else if (platform == "web" && esl == "zh_Hant") { WatchNow.title = "立即觀看"; Originals.title = "Apple TV+"; Movies.title = "電影"; TV.title = "電視節目"; Sports.title = "體育節目"; Kids.title = "兒童"; Library.title = "資料庫"; Search.title = "搜索" }
    else if (esl == "zh_Hant") { WatchNow.title = "立即觀看"; Originals.title = "Apple TV+"; Movies.title = "電影"; TV.title = "電視節目"; Sports.title = "體育節目"; Kids.title = "兒童"; Library.title = "資料庫"; Search.title = "搜索" }
    else 
    */
