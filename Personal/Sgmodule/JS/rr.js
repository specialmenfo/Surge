    ...
    switch (true) {
      ...
      case rrtv_tab_home.test(magicJS.request.url):
        try {
          ...
          magicJS.logError(`首頁去廣告出現異常：${err}`);
        }
        break;
      //去除廣場
      case rrtv_tab_cfg.test(magicJS.request.url):
        try {
          ...
          magicJS.logError(`廣場去廣告出現異常：${err}`);
        }
        break;
        //去除商城廣告
      case rrtv_tab_my.test(magicJS.request.url):
        try {
          ...
          magicJS.logError(`商城去廣告出現異常：${err}`);
        }
        break;
      //rrtv_privilege
      case rrtv_privilege.test(magicJS.request.url):
        try {
          let obj = JSON.parse(magicJS.response.body);
          obj.data = [{"id":1,"effectObject":"video","action":"play","function":"originalPainting","func":"originalPainting","description":"解鎖原畫","icon":"jiesuoyuanhua","endTime":9999940148000},{"id":4,"effectObject":"video","action":"play","function":"noLimit","func":"noLimit","description":"看劇無限制","icon":"kanjuwuxianzhi","endTime":9999940148000},{"id":23,"effectObject":"video","action":"play","function":"noAd","func":"noAd","description":"看劇無廣告","icon":"kanjuwuguanggao","endTime":9999940148000},{"id":43,"effectObject":"danmu","action":"send","function":"superBarrageBlue","func":"superBarrageBlue","description":"超級彈幕","icon":"chaojidanmu","endTime":9999940148000},{"id":46,"effectObject":"video","action":"play","function":"vipVideo","func":"vipVideo","description":"勳章專享劇集","icon":"zhuanxiangjuji","endTime":9999940148000},{"id":45,"effectObject":"mall","action":"sale","function":"mallDiscount","func":"mallDiscount","description":"龍醇商城九折","icon":"longchunshangcheng","endTime":9999940148000},{"id":37,"effectObject":"growth","action":"play","function":"0.4","func":"0.4","description":"看劇經驗+40%","icon":"jingyanzhijiacheng","endTime":9999940148000},{"id":25,"effectObject":"nickName","action":"show","function":"nameHighLight","func":"nameHighLight","description":"高亮暱稱","icon":"gaoliangnicheng","endTime":9999940148000},{"id":24,"effectObject":"comment","action":"write","function":"highLight","func":"highLight","description":"高亮評論回復","icon":"https://img.rr.tv/static/images/20170926/HighLigthComment@2x.png","endTime":9999940148000},{"id":20,"effectObject":"article","action":"write","function":"highLight","func":"highLight","description":"高亮發帖","icon":"gaoliangfatie","endTime":9999940148000}];
          body = JSON.stringify(obj);
        } catch (err) {
          magicJS.logError(`privilege去廣告出現異常：${err}`);
        }
        break;
        //rrtv_ad_getall
      case rrtv_ad_getall.test(magicJS.request.url):
        try {
          ...
          magicJS.logError(`ad_getall去廣告出現異常：${err}`);
        }
        break;
         //rrtv_drama
      case rrtv_drama_detail.test(magicJS.request.url):
        try {
          ...
          magicJS.logError(`drama去廣告出現異常：${err}`);
        }
        break;
        //rrtv_watch_4
      case rrtv_watch_v4.test(magicJS.request.url):
        try {
          ...
          magicJS.logError(`watch_4去廣告出現異常：${err}`);
        }
        break;
        //rrtv_pro
      case rrtv_tv.test(magicJS.request.url):
        try {
          ...
          obj.data.user.privilegeList=[{"id":null,"createTimeStr":"","createTime":null,"updateTime":null,"effectObject":"video","action":"play","function":"originalPainting","func":"originalPainting","description":"解鎖原畫","icon":"jiesuoyuanhua","endTime":9999987654321},{"id":null,"createTimeStr":"","createTime":null,"updateTime":null,"effectObject":"mall","action":"sale","function":"mallDiscount","func":"mallDiscount","description":"龍醇商城九折","icon":"longchunshangcheng","endTime":9999987654321},{"id":null,"createTimeStr":"","createTime":null,"updateTime":null,"effectObject":"article","action":"write","function":"highLight","func":"highLight","description":"高亮發帖","icon":"gaoliangfatie","endTime":9999987654321},{"id":null,"createTimeStr":"","createTime":null,"updateTime":null,"effectObject":"nickName","action":"show","function":"nameHighLight","func":"nameHighLight","description":"高亮暱稱","icon":"gaoliangnicheng","endTime":9999987654321},{"id":null,"createTimeStr":"","createTime":null,"updateTime":null,"effectObject":"comment","action":"write","function":"highLight","func":"highLight","description":"高亮評論回復","icon":"huifu","endTime":9999987654321},{"id":null,"createTimeStr":"","createTime":null,"updateTime":null,"effectObject":"danmu","action":"send","function":"superBarrageBlue","func":"superBarrageBlue","description":"超級彈幕","icon":"chaojidanmu","endTime":9999987654321},{"id":null,"createTimeStr":"","createTime":null,"updateTime":null,"effectObject":"video","action":"play","function":"vipVideo","func":"vipVideo","description":"勳章專享劇集","icon":"zhuanxiangjuji","endTime":9999987654321},{"id":null,"createTimeStr":"","createTime":null,"updateTime":null,"effectObject":"growth","action":"play","function":"0.4","func":"0.4","description":"看劇經驗+40%","icon":"jingyanzhijiacheng","endTime":9999987654321},{"id":null,"createTimeStr":"","createTime":null,"updateTime":null,"effectObject":"video","action":"play","function":"noLimit","func":"noLimit","description":"看劇無限制","icon":"kanjuwuxianzhi","endTime":9999987654321},{"id":null,"createTimeStr":"","createTime":null,"updateTime":null,"effectObject":"video","action":"play","function":"noAd","func":"noAd","description":"看劇無廣告","icon":"kanjuwuguanggao","endTime":9999987654321}];
          ...
          magicJS.logError(`pro去廣告出現異常：${err}`);
        }
        break;
        ...
        try {
          ...
          magicJS.logError(`rrtv_level出現異常：${err}`);
        }
        break;
      default:
