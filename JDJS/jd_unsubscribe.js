...
腳本：取關京東店鋪和商品
更新時間：2021-05-08
因種豆得豆和寵汪汪以及NobyDa大佬的京東簽到腳本會關注店鋪和商品，故此腳本用來取消已關注的店鋪和商品
默認：每運行一次腳本全部已關注的店鋪與商品
建議此腳本運行時間在 種豆得豆和寵汪汪腳本運行之後 再執行
現有功能: 1、取關商品。2、取關店鋪。3、匹配到boxjs輸入的過濾關鍵詞後，不再進行此商品/店鋪後面(包含輸入的關鍵詞商品/店鋪)的取關
腳本兼容: Quantumult X, Surge, Loon, JSBox, Node.js, 小火箭
==============Quantumult X===========
[task_local]
#取關京東店鋪商品
55 23 * * * jd_unsubscribe.js, tag=取關京東店鋪商品, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
===========Loon============
[Script]
cron "55 23 * * *" script-path=jd_unsubscribe.js,tag=取關京東店鋪商品
============Surge=============
取關京東店鋪商品 = type=cron,cronexp="55 23 * * *",wake-system=1,timeout=3600,script-path=jd_unsubscribe.js
===========小火箭========
取關京東店鋪商品 = type=cron,script-path=jd_unsubscribe.js, cronexpr="55 23 * * *", timeout=3600, enable=true
 */
